        ...
        <section className="hero is-medium is-primary is-bold">
          <div className="hero-body">
            <div className="container">
              <h1 className="title">React Orchestra Web Demo</h1>
              <h2 className="subtitle">Better with headphones on.</h2>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div className="heading">
              ...
              <h2 className="subtitle">Play it by clicking or tapping notes</h2>
              <hr />
        ...
        <section className="section">
          <div className="container">
            <div className="heading">
              ...
              <h2 className="subtitle">Notes generated by NoteFactory</h2>
              <hr />
              <NoteFactoryExample />
            </div>
          </div>
        ...
        <section className="section">
          <div className="container">
            <div className="heading">
              ...
              <h2 className="subtitle">
                Notes that listen to q w e r t y u respectively. Mapping of
