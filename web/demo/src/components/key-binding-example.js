...
const renderNote = (instrumentName, noteName, shouldPlay) => <div className={`button ${shouldPlay ? 'is-primary' : ''}`} style={{ cursor: 'pointer' }}> I am a note : {instrumentName} {noteName} You can click me ! or play me using your keyboard !</div>;
...
class KeyBindingExample extends React.Component {
  ...
  render() {
    return (
      <div>
        <KeyBinding keyName="q" onKeyDown={this.onKeyDown} onKeyUp={this.onKeyUp} />
